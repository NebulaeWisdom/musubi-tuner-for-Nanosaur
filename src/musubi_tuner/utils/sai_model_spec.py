...
IMPL_NANOSAUR = "https://www.modelscope.cn/models/xiaobaibai030/well9472-Nanosaur-1.2B-Preview"
...
def build_metadata(
    ...
    if architecture == ARCHITECTURE_HUNYUAN_VIDEO:
        ...
        arch = ARCH_Z_IMAGE
        impl = IMPL_Z_IMAGE
    elif architecture == ARCHITECTURE_NANOSAUR:
        arch = ARCH_NANOSAUR
        impl = IMPL_NANOSAUR
    else:
    ...
    if reso is not None:
        ...
        if architecture == ARCHITECTURE_QWEN_IMAGE:
            ...
            reso = (1024, 1024)
        elif architecture == ARCHITECTURE_Z_IMAGE or architecture == ARCHITECTURE_NANOSAUR:
            reso = (1024, 1024)
        else:
            reso = (1280, 720)
